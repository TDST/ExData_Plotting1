...
# Open the output file, set the plot size, and write the plot to the file
png( "plot2.png", width=480, height=480 )
plot( date_time, as.numeric( df$Global_active_power ), type="l", xlab="", ylab="Global Active Power (kilowatts)" )
